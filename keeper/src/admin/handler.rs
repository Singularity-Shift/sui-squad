...
pub fn get_account() -> SuiAddress {
    ...
    file_keystore.save().expect("Failed to save keystore");

    let sender = file_keystore.import_from_mnemonic(seed, SignatureScheme::ED25519, None, None).expect("Failed to import from mnemonic");
